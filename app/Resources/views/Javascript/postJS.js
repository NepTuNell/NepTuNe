    ...
    methods: {
        ...
        postComment: function($post = null) {
            ...
            if ( null !== $post ) {
                ...
                var $pictures = $('#ulPictureEdit > li > input');
                ...
                var $pictures = $('#ulPictureNew > li > input');
        ...
        *****************************************************/
        ...
        deletePostShown: function() {
            ...
            // Suppression du ou des commentaire(s) en mode édition 
...
function addPicture(modeExe = "") 
{
    ...
    $('#'+listeId+' > li').each( function() {
        ...
        if ( "Edit" === modeExe.trim() ) {
            ...
            item.attr('id', id);
            item.append('<i style="float: right; color: white;" class="fas fa-trash imgCursor" onclick="removePictureSelector('+id+',\''+modeExe+'\')"></i>');
 ...
 *****************************************/
function removePictureSelector(el, modeExe = "") 
{
...
function viewPicture(el) 
{
    ...
    if (el.files && el.files[0]) {
        ...
        if ( !imgChild.length ) {
            ...
            liParent.append('<img class="col-4" src="#" alt="your image"/>')
            var imgChild = $(liParent.children('img'));
        } 
 ...
 ************************************************/
function countElem(elem, modeExe = "")
{
